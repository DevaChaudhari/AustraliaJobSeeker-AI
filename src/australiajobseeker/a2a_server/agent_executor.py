...
from australiajobseeker.scrapers.job_details_scraper import get_job_description, get_job_descriptions
from australiajobseeker.scrapers.seek_scraper import search_seek
